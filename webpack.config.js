...
module.exports = env => {
    console.dir(env.android + 'PRODUCTION? '+ env.production);
    ...
    if(env.production){
        plugins.push(new webpack.NormalModuleReplacementPlugin(/.*environments\/environment/, '../environments/environment.prod'));   
